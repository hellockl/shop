...
<script id='tpl_order_info' type='text/html'>
    ...
    <div class="order_main" >
        ...
        <div class="line"><div class="label">支付金额</div><div class="info"><div class="inner"><div style='color:#ff6600'>￥<%order.price%>元</div></div></div>
    </div>
        ...
        core.json('order/pay',{orderid:'<?php  echo $_GPC['orderid'];?>',openid:"<?php  echo $openid;?>"},function(json){
           ...
           if(result.alipay.success){
                 ...
                 $('.order_sub2').click(function(){
                    ...
                    core.json('order/pay', {op: 'pay',type: 'alipay', orderid:'<?php  echo $_GPC['orderid'];?>',openid:"<?php  echo $openid;?>"}, function (rjson) {
                        if(rjson.status!=1){
           ...
           if(result.wechat.success){
                $('.order_sub1').click(function(){   
                        if($(this).attr('submitting')=='1'){
                         ...
                         $('.button').attr('submitting',1);
                         core.json('order/pay', {op: 'pay',type: 'weixin', orderid:'<?php  echo $_GPC['orderid'];?>'}, function (rjson) {
                            if(rjson.status!=1){
                                $('.button').removeAttr('submitting');
                                core.tip.show(rjson.result);
                                return;
