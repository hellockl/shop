...
<title>确认订单</title>
<style type="text/css">
    body {margin:0px; background:#efefef;font-family:sans-serif;}
    ...
    <div class="chooser choose_dispatch">
        ...
        <div class="address dispatch"   
            ...
            <div class="info" >
                ...
                <div class='inner'>
                      <div class="name" style='padding-top:10px;'><%d.dispatchname%> <%d.price%>元</div>
                </div>    
...
<script id='tpl_confirm_info' type='text/html'>
    ...
    <div class="addorder_price">
        ...
        <div class="all">需付<span class='totalprice'>￥<%realprice%></span></div>
    </div>
...
var fromcart = 0;
    require(['tpl', 'core'], function(tpl, core) {
        ...
        function calctotalprice() {
            ...
            var totalprice = goodsprice + dispatchprice - discountprice;
        ...
        $('.paysub').click(function() {
            ...
            core.json('order/confirm', data, function(create_json) {
                ...
                if (create_json.status == 1) {
                    ...
                    $(this).html('确认订单').removeAttr('saving');
