...
<a class="switch_btn" hidefocus="true" id="switcher_qlogin" href="<?php  echo url('user/login');?>"tabindex="7">快速登录</a> 
<a class="switch_btn_focus" hidefocus="true" id="switcher_plogin" href="<?php  echo url('user/register');?>" tabindex="8">&nbsp;帐号注册</a>

<div class="switch_bottom" id="switch_bottom" style="margin-left: -5px;left: 160px; width: 77px; position: absolute;"></div>
</div></div>
...
<form id="loginform" autocomplete="off" name="loginform" action="<?php  echo url('user/login');?>" method="post"  role="form" style="margin:0" onsubmit="return formcheck();">
...
<div class="verifyArea" id="verifyArea"><div class="verifyinputArea" id="verifyinputArea"><label class="input_tips" id="vc_tips" for="verifycode">验证码</label><div class="inputOuter">
<input name="verifycode" type="text" class="inputstyle verifycode" id="verify" name="verify" value="" tabindex="3"></div></div><div class="verifyimgArea" id="verifyimgArea"><img class="verifyimg" id="verifyimg" title="看不清，换一张"> <a tabindex="4" href="javascript:void(0);" id="verifyChange" class="verifyimg_tips">看不清，换一张</a></div></div>
  <?php  } ?>
...
<div class="bottom" id="bottom_web" style="display: block;"><a href="<?php  echo url('user/register');?>" class="link1" target="_blank">注册新帐号</a></div>

</div></div></div>

<div class="web_qr_login" id="web_qr_register" style="display: block;">
<div class="web_qr_login_show" id="web_qr_login_show"><div class="web_login" id="web_login"><div class="tips" id="tips">
