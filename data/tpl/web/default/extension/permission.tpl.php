		...
		<table class="table">
			<tr>
				...
				<td>
					...
					<?php  } } ?>
					<?php  } ?>
					<span class="help-block">订阅特定的消息类型后, 此消息类型的消息到达微信系统后将会以通知的方式(消息数据只读, 并不能返回处理结果)调用模块的接受器, 用这样的方式可以实现全局的数据统计分析等功能. 请参阅 <a href="http://www.012wz.com/docs/#flow-module-subscribe">模块消息订阅</a></span>
