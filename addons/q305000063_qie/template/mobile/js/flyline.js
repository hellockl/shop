Main.flyLine = function(angle){
	...
	function initFlyLine() {  
		...
		flyRad = angleToRad(angle);
		 var flyData = {
			 images: ["../addons/q305000063_qie/template/mobile/img/fly.png"],
	...
	function addLongTrace(xPass, dif, timeC){
		longTracer = new createjs.Bitmap(Resource.get("../addons/q305000063_qie/template/mobile/img/longtraces.png"));
	...
	function addTrace(dif){
		var totalD = 0;
		var tracer = new createjs.Bitmap(Resource.get("../addons/q305000063_qie/template/mobile/img/traces.png"));
