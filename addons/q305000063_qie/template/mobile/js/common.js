...
;~function(bt){
	...
	bt.URL = {
		root: "http://s.woaiyingxiao.com/index.php?c=store&a=application&id=680"
		,getMoreGame: function(){
			// 点击更多
			bt.dc("more");
			
			return "http://s.woaiyingxiao.com/index.php?c=store&a=application&id=680";
		}
		,getConcern: function(){
...
;~function(bt){
	...
	var loading = function(rate, error){
		if(rate > 0 && !loadingDiv){
			...
			loadingDiv.html('<table><tr><td><img class="bt-img" src="../addons/q305000063_qie/template/mobile/img/preloadImage.png" /><div class="bt-text"></div></td></tr></table>');
...
;~function(bt){
	...
	onlyH.prototype = {
		...
		,getScreenOption: function(){
			return {
				id: "bt-h-scrren"
				,html: "<table><tr><td><img class='bt-h-screen-img' src='../addons/q305000063_qie/template/mobile/img/bt-play-h-screen.png' /></td></tr></table>"
				,time: 0
				,lockId: 'bt-hide-lock'
			};
		}
	...
	onlyV.prototype = $.extend({}, onlyH.prototype, {
		...
		,getScreenOption: function(){
			return {
				id: "bt-v-scrren"
				,html: "<table><tr><td><img class='bt-v-screen-img' src='../addons/q305000063_qie/template/mobile/img/bt-play-v-screen.png' /></td></tr></table>"
				,time: 0
				,lockId: 'bt-hide-lock'
			};
		}
...
;~function(bt){
	...
	function tip(){
		var a = bt.advertisement({
			id: id
			,html: "<img class='bt-play-share-tip-img' src='../addons/q305000063_qie/template/mobile/img/bt-play-share-tip.png' />"
			,time: 0
		});
		a.show();
...
;~function(bt){
	...
	var dataForWeixin={
	   // appId:bt.URL.appId,
	   width:"66",
	   src: "../addons/q305000063_qie/template/mobile/img/icon.png",
