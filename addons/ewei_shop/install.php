...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_goods') . " (
  ...
  `diyformtype` tinyint(3) NULL DEFAULT '0',
  `diyformid` int(11) NULL DEFAULT '0',
  `diymode` tinyint(3) NULL DEFAULT '0',
  ...
  `shorttitle` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_pcate` (`pcate`),
  KEY `idx_ccate` (`ccate`),
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_order_goods') . " (
  ...
  `printstate2` tinyint(1) NULL DEFAULT '0',
  `printstate` tinyint(1) NULL DEFAULT '0',
  `openid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_orderid` (`orderid`),
  KEY `idx_goodsid` (`goodsid`),
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_postera') . " (
  ...
  `endtext` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_type` (`type`),
  KEY `idx_isdefault` (`isdefault`),
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_article'). " (
  ...
  `article_rule_credit2` int(11) NULL DEFAULT '0',
  `article_rule_money2` decimal(10,2) NULL DEFAULT '0.00',
  `article_rule_creditm` int(11) NULL DEFAULT '0',
  `article_rule_moneym` decimal(10,2) NULL DEFAULT '0.00',
  `article_rule_creditm2` int(11) NULL DEFAULT '0',
  `article_rule_moneym2` decimal(10,2) NULL DEFAULT '0.00',
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_af_supplier') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('ewei_shop_supplier_apply') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(15,15,'diyform','自定义表单','1.0','官方','1','help'),
(16,16,'system','系统工具','1.0','官方','1','help'),
(17,17,'exhelper','快递助手','1.0','官方','1','help'),
(18,18,'supplier','供应商','1.0','官方','1','biz');

";
pdo_query($sql);

/* 插入供应商插件需要的字段到对应的表 */
if(!pdo_fieldexists('ewei_shop_perm_user', 'banknumber')) {
  pdo_query("ALTER TABLE ".tablename('ewei_shop_perm_user')." ADD `banknumber` varchar(255) NOT NULL COMMENT '银行卡号';");
}
if(!pdo_fieldexists('ewei_shop_perm_user', 'accountname')) {
  pdo_query("ALTER TABLE ".tablename('ewei_shop_perm_user')." ADD `accountname` varchar(255) NOT NULL COMMENT '开户名';");
}
if(!pdo_fieldexists('ewei_shop_perm_user', 'accountbank')) {
  pdo_query("ALTER TABLE ".tablename('ewei_shop_perm_user')." ADD `accountbank` varchar(255) NOT NULL COMMENT '开户行';");
}
if(!pdo_fieldexists('ewei_shop_goods', 'supplier_uid')) {
  pdo_query("ALTER TABLE ".tablename('ewei_shop_goods')." ADD `supplier_uid` INT NOT NULL COMMENT '供应商ID';");
}
if(!pdo_fieldexists('ewei_shop_order', 'supplier_uid')) {
  pdo_query("ALTER TABLE ".tablename('ewei_shop_order')." ADD `supplier_uid` INT NOT NULL COMMENT '供应商ID';");
}
if(!pdo_fieldexists('ewei_shop_order_goods', 'supplier_uid')) {
  pdo_query("ALTER TABLE ".tablename('ewei_shop_order_goods')." ADD `supplier_uid` INT NOT NULL COMMENT '供应商ID';");
}
if(!pdo_fieldexists('ewei_shop_order_goods', 'supplier_apply_status')) {
  pdo_query("ALTER TABLE ".tablename('ewei_shop_order_goods')." ADD `supplier_apply_status` tinyint(4) NOT NULL COMMENT '1为供应商已提现';");
}
if(!pdo_fieldexists('ewei_shop_af_supplier', 'id')) {
  pdo_query("ALTER TABLE ".tablename('ewei_shop_af_supplier')." ADD PRIMARY KEY (`id`);");
}
if(!pdo_fieldexists('ewei_shop_supplier_apply', 'id')) {
  pdo_query("ALTER TABLE ".tablename('ewei_shop_supplier_apply')." ADD PRIMARY KEY (`id`);");
}
if(!pdo_fieldexists('ewei_shop_af_supplier', 'id')) {
  pdo_query("ALTER TABLE ".tablename('ewei_shop_af_supplier')." MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;");
}
if(!pdo_fieldexists('ewei_shop_supplier_apply', 'id')) {
  pdo_query("ALTER TABLE ".tablename('ewei_shop_supplier_apply')." MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;");
}
if(!pdo_fieldexists('ewei_shop_perm_role', 'status1')) {
  pdo_query("ALTER TABLE ".tablename('ewei_shop_perm_role')." ADD `status1` tinyint(3) NOT NULL COMMENT '1：供应商开启';");
}
if(!pdo_fieldexists('ewei_shop_perm_user', 'openid')) {
  pdo_query("ALTER TABLE ".tablename('ewei_shop_perm_user')." ADD `openid` VARCHAR( 255 ) NOT NULL;");
}